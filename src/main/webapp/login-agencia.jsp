		...
		<div style="padding-top: 1.5%">
			<section class="hero">
				<div class="hero-login-container">
					...
					<form action="login-agencia.jsp" method="post"
						class="hero-login-form" autocomplete="off">
						<div class="form-group">
							<label for="email">E-mail</label>
							<div class="input-wrapper">
								<i class="fas fa-envelope input-icon"></i> <input type="email"
									id="email" name="email"
									placeholder="Digite o e-mail da agência" required>
							</div>
						</div>
						<div class="form-group">
					...
					<div class="hero-login-register">
						<span>Não tem uma conta?</span> <a href="registrar-agencia.jsp">Registrar-se</a>
					</div>
					<div class="hero-login-password-reset">
						<span>Esqueceu sua senha?</span> <a href="recuperarSenha.html">Recuperar
							Senha</a>
					</div>
				</div>
			</section>
