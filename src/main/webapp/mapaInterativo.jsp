...
<script src="https://unpkg.com/leaflet@1.9.4/dist/leaflet.js"
    crossorigin=""></script>
		...
		height: 300px}
			...
			.passeios-section {
				...
				background: linear-gradient(135deg, var(--azul-espuma) 60%,
						var(--azul-claro) 100%);
				border-radius: 18px;
	...
	<body>
		<header class="header" id="header">
			...
			<nav>
				<a href="index.html"><i class="fas fa-home"></i> In�cio</a> <a href="mapaInterativo.jsp"><i
						class="fas fa-map"></i> Mapa
					Interativo</a> <a href="#"><i class="fas fa-map-marker-alt"></i>
					Locais</a> <a href="#"><i class="fas fa-search"></i> Buscar Passeios</a>
				<a href="#"><i class="fas fa-calendar"></i> Eventos</a> <a href="login.html"><i class="fas fa-user"></i>
					Login/Cadastro</a>
			</nav>
		</header>
		<main>
